    ...
    <Container maxWidth="lg" sx={{ mt: 10, mb: 12 }}>
      ...
      >
        <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
          If you have an idea, we have an app development team which can transform your idea into a secure & feature-packed mobile application. From the initial planning until the final deployment in the app store, our mobile apps development company in India covers everything.
        </Typography>
        <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
          We build both native and cross-platform mobile apps with advanced feature integration based on Augmented Reality, Virtual Reality and many more. When you choose us, you get trust of a brand with 100% money back guarantee, India's best mobile app development team.
        </Typography>
      </Paper>
