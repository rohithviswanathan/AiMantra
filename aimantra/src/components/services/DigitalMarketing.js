    ...
    <Container maxWidth="lg" sx={{ mt: 10, mb: 12 }}>
      ...
      >
        <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
          Owing to the ever-increasing demand and popularity of the web-based and mobile games, the mobile gaming industry is experiencing exponential growth. Today, people seek engaging and interesting games with which they can indulge. We, at AImantra Technology, offer our clients an exhaustive set of iOS and Android game development services that help you transform your vision of a visually splendid game into a reality.
        </Typography>
        <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
          From personal websites to e-stores and corporate websites to custom web apps, AImantra Technology is the all-in-one platform to create a beautiful interactive websites that engage visitors.
        </Typography>
      </Paper>
