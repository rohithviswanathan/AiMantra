    ...
    <Container maxWidth="lg" sx={{ mt: 10, mb: 12 }}>
      ...
      >
        <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
            We Design Visually Stunning & User-Friendly Customer Experience. The Design division at AImantra technology works as an independent wing with a dedicated team of User interface (UI) Designers, User Experience (UX) Designers, Graphic Designers and Animators.
        </Typography>
        <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
