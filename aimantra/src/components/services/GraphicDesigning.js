      ...
      >
        ...
        >
          <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
            Graphic design plays a very crucial role in this competitive market
            as a tool for communication. An impressive graphic design is a
            perfect combination of texts and pictures to explain your business
            ideas through different mediums.
          </Typography>
          <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
            Our team of passionate, skilled and experienced creative experts
            takes pride in giving you results through a wide spectrum of Graphic
            Design expertise. With the creative lead and strategically driven
            solution, we would try your brand to connect with consumers on an
            astonish level.
          </Typography>
        </Paper>
      </motion.div>
