      ...
      >
        ...
        >
          <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
            At AiMantra, we offer comprehensive Social Media Marketing (SMM)
            services that are designed to elevate your brand’s online presence,
            foster engagement, and drive tangible results. Our services are
            tailored to meet the unique needs of each client, ensuring a
            strategic approach that aligns with your business goals.
          </Typography>
        </Paper>
      </motion.div>
